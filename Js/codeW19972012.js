...
// load the data
d3.json("../Json/Work/W19972012.json", function (error, _graph) {
...
function initializeDisplay() {
  ...
  node = svg
    ...
    .enter()
    .append("a")                                        //點選網址
    .attr("xlink:href", function(d) {return "http://papers.cumincad.org/cgi-bin/works/paper/"+ d.name})     
    .on('click',function(d){                            //打開網址
      window.open("http://papers.cumincad.org/cgi-bin/works/paper/"+ d.name)
   });
